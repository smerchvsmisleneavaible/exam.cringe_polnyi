...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 10 2024 г., 11:30
...
INSERT INTO `report` (`id`, `time`, `user_id`, `rate`, `order_id`, `price`, `help`) VALUES
(3, 2, 2, 4, 1, '233.00', 'Всё починили)'),
(5, 2, 3, 2, 3, '2222.00', 'Ну мы всё сломали)))');
